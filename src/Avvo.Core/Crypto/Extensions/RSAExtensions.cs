...
namespace Avvo.Core.Crypto.Extensions
{
    ...
    {
        public static string ToPrivateKey(this RSAParameters key)
        {
            var parameters = key;
        ...
        public static string ToPublicKey(this RSAParameters key)
        {
            var parameters = key;
        ...
        public static RSAParameters FromPrivatekey(this string key)
        {
        ...
        public static RSAParameters FromPublickey(this string key)
        {
